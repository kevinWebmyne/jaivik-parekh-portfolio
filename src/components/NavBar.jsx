...
console.log(location);
  ...
  return (
    <header style={{backgroundColor: location?.pathname === "/" ? "transparent" : "white"}} className="w-full px-32 py-8 font-medium flex items-center justify-between text-dark font-bold  dark:text-dark fixed top-0 bg-dark dark:bg-light z-10 lg:px-16 md:px-12 sm:px-8">
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap ">
          ...
          <motion.a
            href="https://www.linkedin.com/in/jaivik1320/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
      ...
      {isOpen ? (
        <motion.div
          ...
          style={{zIndex: 500000, backgroundColor: "red"}}
        >
